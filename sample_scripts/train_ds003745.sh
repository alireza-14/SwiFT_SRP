...
MAIN_ARGS='--loggername tensorboard --classifier_module v6 --dataset_name DS003745 --image_path /content/SRP_MNI_to_TRs_minmax' 
...
RESUME_ARGS='--load_model_path pretrained_models/hcp_sex_classification.ckpt'
